...
# 데이터 가져오기
url = f"https://www.koreaexim.go.kr/site/program/financial/exchangeJSON?authkey=3KBgM71Eun3za3GDai5a2kltMFmy2LYC&searchdate={20240627}&data=AP01"
...
# ISO 코드 매핑
iso_mapping = {
    0: 'AE', 1: 'AU', 2: 'BH', 4: 'CA', 5: 'CH', 6: 'CN', 7: 'DK', 8: 'EU',
    9: 'GB', 10: 'HK', 11: 'ID', 12: 'JP', 13: 'KR', 15: 'MY', 16: 'NO',
    17: 'NZ', 19: 'SE', 20: 'SG', 21: 'TH', 22: 'US'
}
df['c_iso'] = df.index.map(iso_mapping)
